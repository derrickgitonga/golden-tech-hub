...
export const ProductProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const fetchProducts = async () => {
        ...
        const newProducts: Product[] = [
            ...
            { id: 99931, name: "Google Pixel 9 Pro XL", brand: "Google", price: 1099, rating: 4.9, reviews: 45, images: ["/Grey-Google-Pixel-9-Pro-XL.jpg"], category: "Smartphones", description: "The most powerful Pixel yet with the largest display and advanced AI.", features: ["6.8\" Super Actua Display", "Google Tensor G4", "Pro Triple Rear Camera System", "Gemini Advanced", "7 Years of Pixel Drops", "48-hour Battery Life"] },
            { id: 99932, name: "Google Pixel 9 Pro", brand: "Google", price: 999, rating: 4.8, reviews: 32, images: ["/White-Google-Pixel-9-Pro.jpg"], category: "Smartphones", description: "Pro-level performance in a perfect size, featuring Gemini AI.", features: ["6.3\" Super Actua Display", "Google Tensor G4", "Pro Triple Rear Camera System", "Gemini Advanced", "Polished Finish", "Fast Charging"] },
            ...
            { id: 99934, name: "Google Pixel 9 Pro Fold (Black)", brand: "Google", price: 1745, rating: 4.9, reviews: 15, images: ["/Black-Google-Pixel-9-Pro-Fold.jpg"], category: "Smartphones", description: "The thinnest foldable from Google with a massive display and Gemini AI.", features: ["8\" Super Actua Flex Display", "Google Tensor G4", "Triple Rear Camera System", "Split Screen Multitasking", "Satin Metal Hinge", "24+ Hours Battery"] },
            { id: 99935, name: "Google Pixel 9 Pro Fold (White)", brand: "Google", price: 1820, rating: 4.8, reviews: 12, images: ["/White-Google-Pixel-9-Pro-Fold.jpg"], category: "Smartphones", description: "Unfold a new world of possibilities with the porcelain Pixel 9 Pro Fold.", features: ["8\" Super Actua Flex Display", "Google Tensor G4", "Triple Rear Camera System", "Split Screen Multitasking", "Satin Metal Hinge", "24+ Hours Battery"] },
            { id: 99936, name: "Google Pixel 10 (Blue)", brand: "Google", price: 915, rating: 5.0, reviews: 5, images: ["/Blue-Google-Pixel-10.jpg"], category: "Smartphones", description: "Future-ready performance with the next-gen Google Tensor chip in a stunning Blue finish.", features: ["6.4\" Actua Display", "Google Tensor G5", "Advanced AI Photography", "Next-Gen Assistant", "Eco-Friendly Materials", "All-day Battery"] },
            { id: 99937, name: "Google Pixel 10 (Grey)", brand: "Google", price: 885, rating: 4.9, reviews: 8, images: ["/Grey-Google-Pixel-10.jpg"], category: "Smartphones", description: "Sleek, powerful, and intelligent. The Pixel 10 redefines the smartphone experience.", features: ["6.4\" Actua Display", "Google Tensor G5", "Advanced AI Photography", "Next-Gen Assistant", "Eco-Friendly Materials", "All-day Battery"] },
            { id: 99938, name: "Google Pixel 9 Pro (Pink)", brand: "Google", price: 1025, rating: 4.8, reviews: 20, images: ["/Pink-Google-Pixel-9-Pro.jpg"], category: "Smartphones", description: "Pro-level camera and performance in a stunning Rose Quartz finish.", features: ["6.3\" Super Actua Display", "Google Tensor G4", "Pro Triple Rear Camera System", "Gemini Advanced", "Polished Finish", "Fast Charging"] },
            { id: 99939, name: "Google Pixel 9 Pro (Grey)", brand: "Google", price: 985, rating: 4.9, reviews: 25, images: ["/grey-Google-Pixel-9-Pro.jpg"], category: "Smartphones", description: "The ultimate Google phone with advanced AI and a pro-grade camera system in Hazel.", features: ["6.3\" Super Actua Display", "Google Tensor G4", "Pro Triple Rear Camera System", "Gemini Advanced", "Polished Finish", "Fast Charging"] },
        ];
